...
import com.volvo.group.prototypepurchaseorder._1_0.StandAloneOrderSubLineType;
    ...
    extends OrderLineType
{
    ...
    @XmlElementRef(name = "PurchaseOrderSubLine", namespace = "http://www.openapplications.org/oagis/9", type = JAXBElement.class)
    protected List<JAXBElement<? extends PurchaseOrderSubLineType>> purchaseOrderSubLine;
    @XmlElementRef(name = "PurchaseOrderSchedule", namespace = "http://www.openapplications.org/oagis/9", type = JAXBElement.class)
    protected List<JAXBElement<PurchaseOrderScheduleType>> purchaseOrderSchedule;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link JAXBElement }{@code <}{@link PurchaseOrderSubLineType }{@code >}
     * {@link JAXBElement }{@code <}{@link StandAloneOrderSubLineType }{@code >}
     * 
     * 
     */
    public List<JAXBElement<? extends PurchaseOrderSubLineType>> getPurchaseOrderSubLine() {
        if (purchaseOrderSubLine == null) {
            purchaseOrderSubLine = new ArrayList<JAXBElement<? extends PurchaseOrderSubLineType>>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link JAXBElement }{@code <}{@link PurchaseOrderScheduleType }{@code >}
     * {@link JAXBElement }{@code <}{@link PurchaseOrderScheduleType }{@code >}
     * 
     * 
     */
    public List<JAXBElement<PurchaseOrderScheduleType>> getPurchaseOrderSchedule() {
        if (purchaseOrderSchedule == null) {
            purchaseOrderSchedule = new ArrayList<JAXBElement<PurchaseOrderScheduleType>>();
        }
