define(['app',
        ...
        'jquery-validation',
        'backbone.syphon',
		'hbs!views/mobile/warehouse/view/receive/create-transportlabel'
	...
	Gloria.module('WarehouseApp.View', function(View, Gloria, Backbone, Marionette, $, _) {
		...
		View.CreateTransportLabelView = Marionette.LayoutView.extend({
			...
			handleSaveClick : function(e) {
				e.preventDefault();
				if (this.isValidForm()) {	
					Gloria.WarehouseApp.trigger('Receive:TransLabel:create', this.$el.find('#transportLabelNumber').val());
					this.hideModal(e);					
				}
			},
