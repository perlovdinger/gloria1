...
define(['app',
        ...
        'marionette',
        'backbone.syphon',
		'hbs!views/reports/view/warehouse-general-report',
	...
	Gloria.module('ReportsApp.View', function(View, Gloria, Backbone, Marionette, $, _) {
		...
		View.WarehouseGeneralReportView = Backbone.Marionette.LayoutView.extend({
	...
	return Gloria.ReportsApp.View.WarehouseGeneralReportView;
});
