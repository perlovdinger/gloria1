define(['underscore', 
        ...
        ], function(_, PageableCollection, ProcureLineModel) {
	...
	var ProcureLineCollection = PageableCollection.extend({		
		model : ProcureLineModel,
		url : '/procurement/v1/procurelines',
