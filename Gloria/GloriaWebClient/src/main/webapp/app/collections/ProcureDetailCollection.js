define([ 
         ...
         'models/ProcureDetailModel' 
         ], function(_, Collection, ProcureDetailModel) {
	...
	var ProcureDetailCollection = Collection.extend({		
		model : ProcureDetailModel,			
	...
	return ProcureDetailCollection;
});