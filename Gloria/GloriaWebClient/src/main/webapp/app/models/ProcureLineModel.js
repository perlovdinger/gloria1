define([ 'app',
         ...
         ], function(Gloria, Model) {

	var ProcureLineModel = Model.extend({
		urlRoot : '/procurement/v1/procurelines',
		...
		/* initialize: function () {
		    ...
		    update: function () {
		    	var changedAttribute = _.clone(this.changed);
		        alert("Changed");
		    },*/
		/**
		 * @author a043104
