define(['app',
	    ...
	    'i18next',
	    'jquery-validation',
	    'hbs!views/warehouse/qualityinspection/overview/view/print-tl-modal'
	...
	Gloria.module('WarehouseApp.View', function(View, Gloria, Backbone, Marionette, $, _) {
		...
		View.PrintTLModalView = Marionette.LayoutView.extend({
	        ...
	        initialize : function(options) {
	        	...
	        	this.listenTo(Gloria.WarehouseApp, 'qualityInspection:printTL:printed', function(flag) {
    				this.$el.modal('hide');
				});
	        },
			...
			handlePrintClick : function(e) {
	    		...
	    		if (this.isValidForm()) {	    			
	    			Gloria.WarehouseApp.trigger('qualityInspection:printTL:print', this.$el.find('#view-select').val());
	    		};
			},
