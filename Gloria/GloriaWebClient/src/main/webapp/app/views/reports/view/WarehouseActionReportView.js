...
define(['app',
        ...
        'marionette',
        'backbone.syphon',
		'hbs!views/reports/view/warehouse-action-report',
	...
	Gloria.module('ReportsApp.View', function(View, Gloria, Backbone, Marionette, $, _) {
		...
		View.WarehouseActionReportView = Backbone.Marionette.LayoutView.extend({
	...
	return Gloria.ReportsApp.View.WarehouseActionReportView;
});
