 ...
 */
define([ 'underscore', 'app', 'marionette', 'utils/marionette/GloriaRouter',
		'controllers/controllerManager', 'controllers/globalController',
		'utils/UserHelper' ], function(_, Gloria, Marionette, GloriaRouter,
	...
	var MainAppRouter = GloriaRouter.extend({
		...
		getGlobalController : function(args, globalController) {
			if (!globalController) {
				this.controllerManager.getController('desktopController', this.getGlobalController, args);
			} else {
