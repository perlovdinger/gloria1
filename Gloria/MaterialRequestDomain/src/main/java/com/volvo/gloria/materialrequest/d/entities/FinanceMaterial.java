...
public class FinanceMaterial implements Serializable {
    ...
    @Column(name = "FINANCE_MATERIAL_OID")
    private long financeMaterialOid;
    ...
    public long getFinanceMaterialOid() {
        return financeMaterialOid;
    }
    
    public void setFinanceMaterialOid(long financeMaterialOid) {
        this.financeMaterialOid = financeMaterialOid;
    }
