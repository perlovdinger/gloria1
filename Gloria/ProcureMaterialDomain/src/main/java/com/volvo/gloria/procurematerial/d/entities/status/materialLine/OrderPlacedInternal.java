...
/**
 * Status after the internal is created. 
 */
public class OrderPlacedInternal extends MaterialLineDefaultOperation {
    ...
    public void cancel(MaterialLine materialLine, MaterialHeaderRepository requestHeaderRepository, TraceabilityRepository traceabilityRepository,
        ...
        MaterialLineStatusHelper.cancelInternalOrderPlacedMaterialLines(materialLine, requestHeaderRepository, traceabilityRepository, userDTO);
        this.trace(materialLine, action, actionDetail, GloriaTraceabilityConstants.ORDER_CANCELLED, userDTO, traceabilityRepository);
    }
}
